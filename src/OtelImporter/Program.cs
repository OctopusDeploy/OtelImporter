...
internal static class Importer
{
    ...
    static void PrintUsage(TextWriter writer)
    {
        ...
        writer.WriteLine("  <input>[,<input>...]    One or more comma-separated paths to .jsonl/.jsonl.zst OTLP");
        writer.WriteLine("                          trace files, or directories; every .jsonl/.jsonl.zst file");
        writer.WriteLine("                          directly inside each directory is processed in name order.");
        writer.WriteLine();
